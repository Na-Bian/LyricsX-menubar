...
这是一个基于 [LyricsX](https://github.com/ddddxxx/LyricsX) 的个人精简版 fork。原版 LyricsX 是功能完整的 macOS 歌词应用，包含桌面歌词、独立歌词窗口、Touch Bar 歌词和菜单栏歌词等显示方式；本版本只保留个人长期使用的 **菜单栏歌词显示**，让应用尽量安静地留在菜单栏里工作。
